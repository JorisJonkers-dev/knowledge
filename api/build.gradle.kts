...
tasks
    .matching { it.name in listOf("runKtlintCheckOverMainSourceSet", "runKtlintFormatOverMainSourceSet") }
    .configureEach {
...
dependencies {
    ...
    // `client-spec/openapi/knowledge-api.json` is the contract knowledge-ui
...
tasks.register<Test>("exportOpenApiSpec") {
    description = "Exports the OpenAPI spec to client-spec/openapi/knowledge-api.json from a springdoc MVC slice"
    group = "documentation"
