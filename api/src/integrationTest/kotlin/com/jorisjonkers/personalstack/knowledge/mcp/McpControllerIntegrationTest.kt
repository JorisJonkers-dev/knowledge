...
class McpControllerIntegrationTest
    ...
    constructor(
        ...
        @Test
        fun mcpWithoutAuthorizationHeaderReturnsUnauthorizedWithJsonRpcErrorBody() {
            val result =
                mockMvc
                    .post("/mcp") {
            ...
            assertThat(body["error"]["code"].asInt()).isEqualTo(UNAUTHORIZED_CODE)
        }

        @Test
        fun mcpWithWrongBearerTokenReturnsUnauthorized() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun mcpPingWithValidBearerReturnsEmptyResultAndSetsXUserId() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
            ...
            assertThat(body["id"].asText()).isEqualTo("test-request")
        ...
        @Test
        fun mcpInitializeAdvertisesToolsAndPromptsCapabilitiesPlusTheProtocolVersion() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun mcpToolsListAdvertisesTheRegisteredToolsAsAJsonRpcResultArray() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun mcpPromptsListReturnsTheRegisteredPromptsWithTheirArgumentMetadata() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun mcpPromptsGetRendersTheRecallForTaskMessageWithTheSuppliedTaskVerbatim() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun mcpPromptsGetOnAnUnknownNameReturnsMethodNotFound() {
            val result =
                mockMvc
                    .post("/mcp") {
                        contentType = MediaType.APPLICATION_JSON
        ...
        @Test
        fun nonMcpPathsAreUnaffectedByTheBearerFilter() {
            ...
            assertThat(result.response.status).isNotEqualTo(
                org.springframework.http.HttpStatus.UNAUTHORIZED
                    .value(),
            )
        }
