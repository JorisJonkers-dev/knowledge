 ...
 */
class KnowledgeRestIntegrationTest
    @Autowired
    constructor(
        ...
        @Test
        fun getRecentReturnsNotesOrderedMostRecentFirstWithTheSnakeCaseWireShape() {
        ...
        @Test
        fun getNoteByIdReturnsNotFoundOnMissAndOkWithTheNotePayloadOnHit() {
        ...
        @Test
        fun getRecallSurfacesFTSHitsAndReportsTheResolvedMode() {
        ...
        @Test
        fun getInboxSurfacesUnclassifiedNotesOnly() {
        ...
        @Test
        fun getTopicsReturnsSlugsInUseWithCounts() {
        ...
        @Test
        fun getAuditListsRowsWithSnakeCaseKeys() {
